...
const DocumentacionAuditoria: React.FC = () => {
  const { documentos, agregarDocumento, actualizarDocumento, eliminarDocumento } = useDocumentacion('auditoria');
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Gestión de documentación para auditorías
              </p>
            </div>
            <button
              onClick={handleAdd}
...
export default DocumentacionAuditoria;
