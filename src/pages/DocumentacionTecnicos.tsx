...
const DocumentacionTecnicos: React.FC = () => {
  const { documentos, agregarDocumento, actualizarDocumento, eliminarDocumento } = useDocumentacion('tecnicos');
...
export default DocumentacionTecnicos;
